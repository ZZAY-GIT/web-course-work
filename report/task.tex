...
\begin{longtable}{|P{0.50\textwidth}|C{0.11\textwidth}|C{0.15\textwidth}|C{0.24\textwidth}|}
    ...
    Задача 1.1. Обзор существующих программных продуктов по теме работы                               & 10                 & 3.04.2026     &                     \\ \hline
    Задача 1.2. Анализ программных инструментов разработки веб-приложений                             & 7                  & 10.04.2026    &                     \\ \hline
    ...
    Задача 2.2. Описание функциональности приложения (диаграмма вариантов использования, user story)  & 7                  & 02.05.2026    &                     \\ \hline
    Задача 2.3. Проектирование модели данных (ER-диаграмма, логическая и физическая схемы БД)         & 8                  & 9.05.2026     &                     \\ \hline
    ...
    Задача 3.1. Разработка базовой структуры приложения и вёрстка шаблонов страниц                    & 8                  & 23.05.2026    &                     \\ \hline
    Задача 3.2. Реализация аутентификации пользователей                                               & 7                  & 30.05.2026    &                     \\ \hline
    Задача 3.3. Реализация CRUD-интерфейса для пользователей, записей на приём и медицинских карт с поддержкой загрузки и выгрузки файлов & 7 & 02.06.2026 & \\ \hline
    Задача 3.4. Реализация системы управления расписанием и онлайн-записью на приём                  & 12                 & 04.06.2026    &                     \\ \hline
    Задача 3.5. Разработка личного кабинета с просмотром медкарты и истории посещений                 & 6                  & 06.06.2026    &                     \\ \hline

    \multicolumn{4}{|P{\textwidth}|}{\textbf{Раздел 4. Оформление итогов работы}}                                                                               \\ \hline
    Задача 4.1. Создание Git-репозитория с кодом проекта                                             & 3                  & 7.06.2026     &                     \\ \hline
...
\noindent
\begin{tabularx}{\textwidth}{@{} P{0.38\textwidth} P{0.27\textwidth} P{0.35\textwidth} @{}}
...
\begin{tabularx}{\textwidth}{@{} P{0.45\textwidth} P{0.55\textwidth} @{}}
    ...
    \hfill «15» \quad июня \quad 2026~г. \\
\end{tabularx}
}

\begin{minipage}{\textwidth}
Задание принял к исполнению\vspace{0.1cm}

{
\renewcommand{\arraystretch}{1.1}
\begin{tabularx}{\textwidth}{@{} P{0.38\textwidth} P{0.27\textwidth} P{0.35\textwidth} @{}}
    «03» \quad апреля \quad 2026~г. &
    \centering \rule{3.5cm}{0.4pt} \par \footnotesize (подпись) &
    \hfill Д.~О.~Амплеенков                                      \\
\end{tabularx}
}
\end{minipage}
