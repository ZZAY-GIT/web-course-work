...
class Patient(db.Model):
    ...
    medical_record = db.relationship(
        "MedicalRecord", backref="patient", uselist=False, cascade="all, delete-orphan"
    )
    documents = db.relationship(
        "Document", backref="patient", lazy=True, cascade="all, delete-orphan"
    )
...
class Doctor(db.Model):
    ...
    slots = db.relationship(
        "ScheduleSlot", backref="doctor", lazy=True, cascade="all, delete-orphan"
    )
...
class Appointment(db.Model):
    ...
    slot_id = db.Column(
        db.Integer, db.ForeignKey("schedule_slots.id"), unique=True, nullable=False
    )
    status = db.Column(
    ...
    visit = db.relationship(
        "Visit", backref="appointment", uselist=False, cascade="all, delete-orphan"
    )
...
class MedicalRecord(db.Model):
    ...
    visits = db.relationship(
        "Visit", backref="record", lazy=True, cascade="all, delete-orphan"
    )
...
class Document(db.Model):
    ...
    visit_id = db.Column(
        db.Integer, db.ForeignKey("visits.id", ondelete="SET NULL"), nullable=True
    )
